...
//			// 아직 구현 안되었는데, dx 바운드 구해서 왼쪽 좌표를 빼서 구하기 		
//			 dx = cx - cx * sx;
//			 break;
//		 case eWW: 
//			 sx = (w+ox2-x2)/w; 
...
//		 case eSS: 
//			 sy = (h+y2-oy2)/h;
////			 cy = this.anchors[this.eSelectedAnchor.ordinal()].getCenterY();
//			 break;
//		 case eNN: 
//			 sy = (h+oy2-y2)/h; 
////			 cy = this.anchors[this.eSelectedAnchor.ordinal()].getCenterY();
...
//		affineTransform.translate(dx, dy); // 중심 보정, 안되면 계산 수정하기
//		this.shape = affineTransform.createTransformedShape(this.shape);
//
//		graphics2D.draw(this.shape);
//	}
