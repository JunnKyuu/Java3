...
public class GMainFrame extends JFrame {
	...
	public class ShapeActionHandler implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			EShapeButtons eShapeButton = EShapeButtons.valueOf(e.getActionCommand()); // 객체를 찾는 것. eRec, eOval,,,
			drawingPanel.setShapeTool(eShapeButton.getShapeTool()); // drawingPanel에 도구를 던져주자
		}
